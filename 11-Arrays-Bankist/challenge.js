...
const checkDogs = function (dogsJulia, dogsKate) {
  ...
  const bothDogs = juliaDogs.concat(dogsKate);
  bothDogs.forEach(function (d, i, arr) {
    if (d >= 3) {
      console.log(`Dog number ${i + 1}: is an adult and is ${d} years old`);
    } else {
      console.log(`Dog number ${i + 1}: is a puppy and is ${d} years old`);
    }
  });
};

//console.log(checkDogs(jd1, kd1));
//console.log(checkDogs(jd2, kd2));
